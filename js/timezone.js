function setTimezone(tz) {
    ...
    schedule = {
        ...
        "#break1_end": new Date(Date.parse("23 Oct 11:45:00 IST")),

        "#challenge1_start": new Date(Date.parse("23 Oct 10:45:00 IST")),
        "#challenge1_end": new Date(Date.parse("23 Oct 11:25:00 IST")),

        "#challenge2_start": new Date(Date.parse("23 Oct 11:25:00 IST")),
        "#challenge2_end": new Date(Date.parse("23 Oct 12:05:00 IST")),

        "#lunch_start": new Date(Date.parse("23 Oct 12:05:00 IST")),
        "#lunch_end": new Date(Date.parse("23 Oct 12:30:00 IST")),

        "#challenge3_start": new Date(Date.parse("23 Oct 12:30:00 IST")),
        "#challenge3_end": new Date(Date.parse("23 Oct 13:10:00 IST")),

        "#challenge4_start": new Date(Date.parse("23 Oct 13:10:00 IST")),
        "#challenge4_end": new Date(Date.parse("23 Oct 13:50:00 IST")),

        "#challenge5_start": new Date(Date.parse("23 Oct 13:50:00 IST")),
        "#challenge5_end": new Date(Date.parse("23 Oct 14:30:00 IST")),

        "#break2_start": new Date(Date.parse("23 Oct 14:30:00 IST")),
        ...
        "#panel_start": new Date(Date.parse("23 Oct 2022 16:15:00 IST")),
        "#panel_end": new Date(Date.parse("23 Oct 2022 17:00:00 IST")),
